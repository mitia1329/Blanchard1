...
!function webpackUniversalModuleDefinition(root, factory) {
      ...
      var EventHandlers = {
          ...
          mouseenterEvent: function mouseenterEvent() {
              ...
              (this.inputmask.shadowRoot || document).activeElement !== this) {
                  ...
                  _inputHandling.HandleNativePlaceholder)(this, bufferTemplate)
              }
          },
  ...
  , function(module, exports, __webpack_require__) {
      ...
      function extend() {
          ...
          target = arguments[i] || {},
          i++),
          "object" !== _typeof(target) && "function" != typeof target && (target = {}); i < length; i++)
              if (null != (options = arguments[i]))
                  for (name in options)
                      src = target[name],
                      copy = options[name],
                      target !== copy && (deep && copy && ("[object Object]" === Object.prototype.toString.call(copy) || (copyIsArray = Array.isArray(copy))) ? (clone = copyIsArray ? (copyIsArray = !1,
  ...
  , function(module, exports, __webpack_require__) {
      ...
      function off(events, handler) {
          ...
          function resolveNamespace(ev, namespace) {
              ...
              if (0 < ev.length)
                  if (void 0 === handler)
                      for (hndx = 0,
                      hndL = eventRegistry[ev][namespace].length; hndx < hndL; hndx++)
                          evts.push({
                              ev: ev,
      ...
      exports.Event = Event,
      "function" == typeof _window.default.CustomEvent ? exports.Event = Event = _window.default.CustomEvent : _canUseDOM.default && (exports.Event = Event = function Event(event, params) {
          params = params || {
              bubbles: !1,
              cancelable: !1,
              detail: void 0
